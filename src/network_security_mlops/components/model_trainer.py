...
from network_security_mlops.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact
...
from network_security_mlops.utils.io_utils import save_object, load_object, load_numpy_array_data, evaluate_models
from network_security_mlops.utils.ml_utils.metric.classification_metric import get_classification_score
...
import dagshub
dagshub.init(repo_owner='inglesantosh09', repo_name='network-security-mlops', mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self, X_train, y_train, X_test, y_test) -> ModelTrainerArtifact:
        ...
        try:
            ...
            # Save models
            self.model_trainer_config.trained_model_file_path.parent.mkdir(parents=True, exist_ok=True)
